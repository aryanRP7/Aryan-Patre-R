  ...
  return (
    <div className="container-fluid containerPage7">
      ...
      <div className="row row2Page7"> 
        ...
        <div className="col-12 col-md-6 g-0 border text-page7">
        Automatic Speed & Accident Avoidence System
        </div>
      </div>
      <div className="row row3Page7">
        ...
        <div className="col-12 col-md-6 order-sm-1 g-0 border text-page7 text-project2-page7 ">
      ...
      <div className="row row4Page7">
        ...
        <div className="col-12 col-md-6 order-xs-2 g-0 border text-page7">
